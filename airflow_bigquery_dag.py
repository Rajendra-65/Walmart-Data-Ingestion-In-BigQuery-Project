...
with DAG(
    ...
    with TaskGroup("load_data") as load_data:
        ...
        gcs_to_bq_merchants = GCSToBigQueryOperator(
            ...
            bucket='bigquery_projects_all',
            source_objects=['walmart_ingestion/merchants/merchants_*.json'],
            destination_project_dataset_table='smiling-castle-431016-v3.walmart_dwh.merchants_tb',
        ...
        gcs_to_bq_walmart_sales = GCSToBigQueryOperator(
            ...
            bucket='bigquery_projects_all',
            source_objects=['walmart_ingestion/sales/walmart_sales_*.json'],
            destination_project_dataset_table='smiling-castle-431016-v3.walmart_dwh.walmart_sales_stage',
            write_disposition='WRITE_TRUNCATE',
            source_format='NEWLINE_DELIMITED_JSON',
        )
    ...
    merge_walmart_sales = BigQueryExecuteQueryOperator(
        ...
        sql="""
            MERGE `smiling-castle-431016-v3.walmart_dwh.walmart_sales_tgt` T
            USING (
                SELECT 
                S.sale_id, 
                S.sale_date, 
                ...
                FROM `smiling-castle-431016-v3.walmart_dwh.walmart_sales_stage` S
                LEFT JOIN `smiling-castle-431016-v3.walmart_dwh.merchants_tb` M
